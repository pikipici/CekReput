      ...
      <div className="space-y-3 sm:space-y-4">
        {timelineData.map((item, index) => {
          ...
          return (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute left-[-7px] sm:left-[-9px] top-0 w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full bg-primary border-4 border-background-dark"></div>

              {/* Date */}
              <div className="text-[10px] sm:text-xs text-slate-400 mb-1.5 sm:mb-2 flex items-center gap-1.5 sm:gap-2">
              ...
              >
                ...
                {item.lossAmount && (
                  <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs text-slate-400">
                    <span className="material-symbols-outlined text-[12px] sm:text-[14px]">payments</span>
