        ...
        <div className="relative glass-panel rounded-2xl p-2 sm:p-3 shadow-2xl">
          <form className="flex flex-col sm:flex-row gap-2" onSubmit={handleSubmit}>
            ...
            <div className="relative min-w-[140px]">
              <select className="w-full h-12 sm:h-14 pl-10 pr-8 bg-background-dark/50 border border-slate-700 text-slate-200 text-sm rounded-xl focus:ring-primary focus:border-primary appearance-none cursor-pointer">
                <option>Semua</option>
