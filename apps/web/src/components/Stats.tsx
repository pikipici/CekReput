    ...
    <section className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="glass-panel rounded-2xl p-6 flex items-center gap-4 hover:bg-slate-800/50 transition-colors cursor-default group">
          <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-slate-800 flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
        ...
        {/* Stat Card 3 */}
        <div className="glass-panel rounded-2xl p-6 flex items-center gap-4 hover:bg-slate-800/50 transition-colors cursor-default group">
          <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-slate-800 flex items-center justify-center text-emerald-500 group-hover:scale-110 transition-transform">
